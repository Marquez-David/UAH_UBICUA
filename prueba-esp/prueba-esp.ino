...
char server[] = "192.168.43.118:8080";
String data2 = "x-x-x-x-x-x-x-y";
...
void loop() {
 ...
 Serial.println("");
  ...
  String valores = String(data1) + "-" + String(data2) + "-" + String(data3) + "-" + String(data4);
  Serial.println("Sttring de int-------");
  ...
  Serial.print("");
   ...
   /* if(client.connect(server, 80)){
      ...
      Serial.print("Me conecto al servidor");
      client.print("POST /v1.0obi/Servlet_arduino_medicion1_in? HTTP/1.1");
      client.print("Host: 192.168.43.118:8080");
      client.print("User-Agent: rduino/1.0");
